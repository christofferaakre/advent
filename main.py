...
'''
Solve the Puzzles provided by AdventOfCode.com year 2018!
'''
...
if __name__ == '__main__':  # Main part
    ...
    save_file = open(
        f'outputs/output{str(args.day)}_{str(args.part)}.txt', 'w')
    save_file.write(f'DAY {str(args.day)} PART {str(args.part)} \n')
    save_file.write(str(solution))
    save_file.close()
